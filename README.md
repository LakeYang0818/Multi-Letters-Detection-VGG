Execute the below line in terminal

```
CUDA_VISIBLE_DEVICES=0 python3 backbone/demo.py \
--Transformation TPS \
--FeatureExtraction ResNet \
--SequenceModeling BiLSTM \
--Prediction Attn \
--image_folder data/demo_data/ \
...
```
CUDA_VISIBLE_DEVICES=0 python3 backbone/train.py \
